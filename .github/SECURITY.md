...
[**Report a vulnerability**](https://github.com/hassio-addons/app-nzbget/security/advisories/new)
...
- Issues in NZBGet itself; please report those directly to the
  [NZBGet project](https://github.com/nzbgetcom/nzbget/security/policy).
...
This security policy covers the NZBGet app in this repository: the app
